...
export const topics: Record<string, Partial<TopicData>> = {
  "sdlc_stlc": {
    ...
    resources: [
      ...
      { type: "video_en", title: "SDLC & STLC Explained", url: "https://www.youtube.com/watch?v=SbHI2b5y0Bw" },
      { type: "video_hi", title: "SDLC and STLC in Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "types_of_testing": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Software Testing Types (freeCodeCamp)", url: "https://www.youtube.com/watch?v=T0TynxN77oY" },
      { type: "video_hi", title: "Types of Software Testing Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "test_cases_plans": {
    ...
    resources: [
      ...
      { type: "video_en", title: "How to Write Test Cases", url: "https://www.youtube.com/watch?v=Zlzhe-7Ftxc" },
      { type: "video_hi", title: "Test Cases in Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "exploratory_testing": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Exploratory Testing Tutorial", url: "https://www.youtube.com/watch?v=PohaPW33Q7o" },
      { type: "video_hi", title: "Exploratory Testing Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "bug_reporting": {
    ...
    resources: [
      ...
      { type: "video_en", title: "How to write a perfect bug report", url: "https://www.youtube.com/watch?v=OWAZ0hRmKTg" },
      { type: "video_hi", title: "Bug Reporting in Jira Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "agile_scrum_qa": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Agile and Scrum Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "programming_for_qa": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Python/Java for Automation Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "selenium_webdriver": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Selenium Full Course (freeCodeCamp)", url: "https://www.youtube.com/watch?v=XI5_nsClCYI" },
      { type: "video_hi", title: "Selenium Java Hindi (Naveen AutomationLabs)", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "cypress_playwright": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Playwright Crash Course", url: "https://www.youtube.com/watch?v=4W7TWu8NmTM" },
      { type: "video_hi", title: "Playwright Tutorial Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "postman_basics": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Postman API Testing Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "rest_assured": {
    ...
    resources: [
      ...
      { type: "video_en", title: "REST Assured API Testing", url: "https://www.youtube.com/watch?v=PohaPW33Q7o" },
      { type: "video_hi", title: "REST Assured Hindi (Naveen AutomationLabs)", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "graphql_testing": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "GraphQL Testing Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "ci_cd_integration": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Jenkins CI/CD Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "performance_testing": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Performance Testing Tutorial (k6)", url: "https://www.youtube.com/watch?v=PohaPW33Q7o" },
      { type: "video_hi", title: "JMeter Load Testing Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
  ...
  "mobile_testing": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Mobile Testing Basics", url: "https://www.youtube.com/watch?v=PohaPW33Q7o" },
      { type: "video_hi", title: "Appium Mobile Automation Hindi", url: "https://www.youtube.com/watch?v=uUqfVcOBlNQ" },
