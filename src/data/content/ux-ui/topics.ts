...
export const topics: Record<string, Partial<TopicData>> = {
  "design_thinking": {
    ...
    resources: [
      ...
      { type: "video_en", title: "What is Design Thinking? (Nielsen Norman Group)", url: "https://www.youtube.com/watch?v=gHGN6hs2gZY" },
      { type: "video_hi", title: "UX/UI Design Thinking Hindi", url: "https://www.youtube.com/watch?v=jujRXhT_rcw" },
  ...
  "user_research": {
    ...
    resources: [
      ...
      { type: "video_en", title: "How to run a User Interview", url: "https://www.youtube.com/watch?v=bAARmsv1tms" },
      { type: "video_hi", title: "UX Research Hindi (NNgroup)", url: "https://www.youtube.com/watch?v=OtUWbsvCujM" },
  ...
  "personas_journey_maps": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "User Persona UX Design Hindi", url: "https://www.youtube.com/watch?v=PHSX-Ybgtho" },
  ...
  "card_sorting": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Card Sorting Explained (NN/g)", url: "https://www.youtube.com/watch?v=AxgMIEVcIMY" },
      { type: "video_hi", title: "Information Architecture UX Hindi (CareerFoundry)", url: "https://www.youtube.com/watch?v=OJLfjgVlwDo" },
  ...
  "sitemaps": {
    ...
    resources: [
      ...
      { type: "video_en", title: "How to Create a User Flow (chunbuns)", url: "https://www.youtube.com/watch?v=TIV1y11xz7k" },
      { type: "video_hi", title: "Sitemap and User Flow Hindi", url: "https://www.youtube.com/watch?v=l6bKXZTuwwI" },
  ...
  "wireframing": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Wireframing for Beginners (CareerFoundry)", url: "https://www.youtube.com/watch?v=qpH7-KFWZRI" },
      { type: "video_hi", title: "Wireframing UX Hindi (CareerFoundry)", url: "https://www.youtube.com/watch?v=qpH7-KFWZRI" },
  ...
  "color_theory": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Color Theory for UI Design (Saptarshi Prakash)", url: "https://www.youtube.com/watch?v=l6LqaAs4hWs" },
      { type: "video_hi", title: "Color Theory in UI Hindi (DesignerUp)", url: "https://www.youtube.com/watch?v=GyVMoejbGFg" },
  ...
  "typography": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Typography in UI Design (Gary Simon)", url: "https://www.youtube.com/watch?v=Ip4iE8-nFzE" },
      { type: "video_hi", title: "Typography UI/UX Hindi (LearnFree)", url: "https://www.youtube.com/watch?v=sByzHoiYFX0" },
  ...
  "layout_grids": {
    ...
    resources: [
      ...
      { type: "video_en", title: "The 8pt Grid System Explained (Figma Layout)", url: "https://www.youtube.com/watch?v=sPHyisUBT0M" },
      { type: "video_hi", title: "Grid System in UI Design Hindi (Fireship)", url: "https://www.youtube.com/watch?v=705XCEruZFs" },
  ...
  "figma_basics": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Figma Auto Layout Masterclass", url: "https://www.youtube.com/watch?v=B_Ih-vFc_Qw" },
      { type: "video_hi", title: "Figma Tutorial Hindi (Welldux)", url: "https://www.youtube.com/watch?v=HS2dF57enLw" },
  ...
  "advanced_prototyping": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Figma Advanced Prototyping & Variables (Boroji Design)", url: "https://www.youtube.com/watch?v=HXDudMspCyg" },
      { type: "video_hi", title: "Figma Prototyping Hindi (Boroji Design)", url: "https://www.youtube.com/watch?v=HXDudMspCyg" },
  ...
  "design_systems": {
    ...
    resources: [
      ...
      { type: "video_en", title: "How to Build a Design System (Bring Your Own Laptop)", url: "https://www.youtube.com/watch?v=kbZejnPXyLM" },
      { type: "video_hi", title: "Design Systems Explained Hindi (Bring Your Own Laptop)", url: "https://www.youtube.com/watch?v=kbZejnPXyLM" },
  ...
  "usability_testing": {
    ...
    resources: [
      ...
      { type: "video_en", title: "How to conduct a Usability Test (Nikoleta Design)", url: "https://www.youtube.com/watch?v=WKIA9bnXHyo" },
      { type: "video_hi", title: "Usability Testing UX Hindi (Nikoleta Design)", url: "https://www.youtube.com/watch?v=WKIA9bnXHyo" },
  ...
  "accessibility_a11y": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Accessibility (a11y) Hindi", url: "https://www.youtube.com/watch?v=VyWRmepESoQ" },
  ...
  "dev_handoff": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Design to Developer Handoff", url: "https://www.youtube.com/watch?v=LfldqERs0aw" },
      { type: "video_hi", title: "Dev Handoff UX Hindi", url: "https://www.youtube.com/watch?v=YLo6g58vUm0" },
