...
export const topics: Record<string, Partial<TopicData>> = {
  "n_gmath_1": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Math for Game Dev: Vectors (Freya Holmér)", url: "https://www.youtube.com/watch?v=QL4_4GAWvPs" },
      { type: "video_hi", title: "Linear Algebra Hindi (Game Dev)", url: "https://www.youtube.com/watch?v=3sytwX6U7Hk" },
  ...
  "n_gmath_2": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Math for Game Dev: Trigonometry", url: "https://www.youtube.com/watch?v=aMqeG_0aFd0" },
      { type: "video_hi", title: "Trigonometry Hindi (Game Dev)", url: "https://www.youtube.com/watch?v=E4hVz2cwQhM" },
  ...
  "n_gmath_3": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Physics in Game Development", url: "https://www.youtube.com/watch?v=9ZEu_I-ido4" },
      { type: "video_hi", title: "Game Physics Hindi (Unity)", url: "https://www.youtube.com/watch?v=TyTU-zS46h0" },
  ...
  "n_geng_1": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Unity Game Dev Hindi", url: "https://www.youtube.com/watch?v=0LNe2VdqakQ" },
  ...
  "n_geng_2": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Unreal Engine Hindi", url: "https://www.youtube.com/watch?v=MbnWLqIxS5s" },
  ...
  "n_geng_3": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Godot in 100 Seconds", url: "https://www.youtube.com/watch?v=e1zJS31tr88" },
      { type: "video_hi", title: "Godot Game Engine Hindi", url: "https://www.youtube.com/watch?v=7fw5-68Y5gY" },
  ...
  "n_gprog_1": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "ECS Game Architecture Hindi", url: "https://www.youtube.com/watch?v=KKHIxUwgiw4" },
  ...
  "n_gprog_2": {
    ...
    resources: [
      ...
      { type: "video_en", title: "State Machines in Game Dev", url: "https://www.youtube.com/watch?v=7jxS8HIny3Q" },
      { type: "video_hi", title: "Finite State Machine Game Dev Hindi", url: "https://www.youtube.com/watch?v=8mB4MxxqhZ4" },
  ...
  "n_gprog_3": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Object Pooling Explained", url: "https://www.youtube.com/watch?v=U08ScgT3RVM" },
      { type: "video_hi", title: "Object Pooling Unity Hindi", url: "https://www.youtube.com/watch?v=3EGXrJRCWLg" },
  ...
  "n_grap_1": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Shaders for Beginners (Freya Holmér)", url: "https://www.youtube.com/watch?v=xnZfMRTmfJY" },
      { type: "video_hi", title: "Shader Graph Unity Hindi", url: "https://www.youtube.com/watch?v=_OL5aMozLW0" },
  ...
  "n_grap_2": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Physically Based Rendering Explained", url: "https://www.youtube.com/watch?v=4QOcCGI6xOU" },
      { type: "video_hi", title: "PBR Materials Hindi (Unity)", url: "https://www.youtube.com/watch?v=jKqvWoxwIUc" },
  ...
  "n_grap_3": {
    ...
    resources: [
      ...
      { type: "video_en", title: "VFX for Games (Gabriel Aguiar)", url: "https://www.youtube.com/watch?v=O75iGGUQXBI" },
      { type: "video_hi", title: "Particle Systems Unity Hindi", url: "https://www.youtube.com/watch?v=T_5NzzANUCc" },
  ...
  "n_ass_1": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Blender Donut Tutorial (Blender Guru)", url: "https://www.youtube.com/watch?v=GIlrEUI5e-w" },
      { type: "video_hi", title: "Blender 3D Hindi Tutorial", url: "https://www.youtube.com/watch?v=03lSeICb39U" },
  ...
  "n_ass_2": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Game Audio Editing Hindi", url: "https://www.youtube.com/watch?v=BK0Nvm4qIBg" },
  ...
  "n_ass_3": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Asset Bundles Unity Hindi", url: "https://www.youtube.com/watch?v=KKHIxUwgiw4" },
  ...
  "n_mp_1": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Multiplayer Game Architecture Explained", url: "https://www.youtube.com/watch?v=Dg1U-jwVUrg" },
      { type: "video_hi", title: "Photon Multiplayer Unity Hindi", url: "https://www.youtube.com/watch?v=HEYY7m7EroU" },
  ...
  "n_mp_2": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Game Networking Sync Hindi", url: "https://www.youtube.com/watch?v=8mB4MxxqhZ4" },
  ...
  "n_mp_3": {
    ...
    resources: [
      ...
      { type: "video_en", title: "How Matchmaking Works", url: "https://www.youtube.com/watch?v=Fn269cI3hd8" },
      { type: "video_hi", title: "Multiplayer Server Hosting Hindi", url: "https://www.youtube.com/watch?v=T_5NzzANUCc" },
