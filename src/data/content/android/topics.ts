...
export const topicsData: Record<string, TopicData> = {
    ...
    "n_bas_1": {
        ...
        resources: [
            ...
            { title: "Android Architecture Explained (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=-QExSMcBvOg" },
            { title: "Android Architecture in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=ada99UCvELI" },
    ...
    "n_bas_2": {
        ...
        resources: [
            ...
            { title: "ART vs Dalvik by Mark Allison", type: "video_en", url: "https://youtube.com/watch?v=0J1bm585UCc" },
            { title: "ART Runtime in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=a1BEoVR6PZk" },
    ...
    "n_bas_3": {
        ...
        resources: [
            ...
            { title: "Android Runtime Permissions (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=D3JCtaK8LSU" },
            { title: "Android Permissions in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=-5LGc3S0S1A" },
    ...
    "n_kot_1": {
        ...
        resources: [
            ...
            { title: "Kotlin Crash Course (Traversy Media)", type: "video_en", url: "https://youtube.com/watch?v=5flXf8nuq60" },
            { title: "Kotlin Full Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=FlBhpm9aRUg" },
    ...
    "n_kot_2": {
        ...
        resources: [
            ...
            { title: "Kotlin Null Safety Explained (Android Developers)", type: "video_en", url: "https://youtube.com/watch?v=-DFTXNNRFE4" },
            { title: "Null Safety in Kotlin Hindi (Anuj Bhaiya)", type: "video_hi", url: "https://youtube.com/watch?v=-DFTXNNRFE4" },
    ...
    "n_kot_3": {
        ...
        resources: [
            ...
            { title: "OOP in Kotlin (Coding in Flow)", type: "video_en", url: "https://youtube.com/watch?v=ikxsvMyHVlM" },
            { title: "Kotlin OOP in Hindi (Smart Programming)", type: "video_hi", url: "https://youtube.com/watch?v=XNOUXhoDdXk" },
    ...
    "n_kot_4": {
        ...
        resources: [
            ...
            { title: "Kotlin Coroutines (Phillip Lackner - full)", type: "video_en", url: "https://youtube.com/watch?v=0Hv5LTxAutw" },
            { title: "Coroutines in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=DVvLFGZFmbI" },
    ...
    "n_tool_1": {
        ...
        resources: [
            ...
            { title: "Android Studio Tutorial (Programming with Mosh)", type: "video_en", url: "https://youtube.com/watch?v=yye7rSsiV6k" },
            { title: "Android Studio Setup in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=PmiSj2QGZVM" },
    ...
    "n_tool_2": {
        ...
        resources: [
            ...
            { title: "Gradle for Android (Coding in Flow)", type: "video_en", url: "https://youtube.com/watch?v=f8cb8m0qz8M" },
            { title: "Gradle Build in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=5s00nKEbCzU" },
    ...
    "n_tool_3": {
        ...
        resources: [
            ...
            { title: "ADB Commands Every Developer Should Know", type: "video_en", url: "https://youtube.com/watch?v=XoJ7o0A-DMc" },
            { title: "ADB and Fastboot in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=MrYsN9P0KTE" },
    ...
    "n_ui_1": {
        ...
        resources: [
            ...
            { title: "ConstraintLayout Tutorial (Coding in Flow)", type: "video_en", url: "https://youtube.com/watch?v=4N4bCdyGcUc" },
            { title: "Android XML UI in Hindi (Hacking with Android)", type: "video_hi", url: "https://youtube.com/watch?v=s1KdR7D2KQ4" },
    ...
    "n_ui_2": {
        ...
        resources: [
            ...
            { title: "Jetpack Compose in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=U5dE-_E1wsg" },
    ...
    "n_ui_3": {
        ...
        resources: [
            ...
            { title: "Material 3 Components in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=ulN6WSZm0wQ" },
    ...
    "n_ui_4": {
        ...
        resources: [
            ...
            { title: "RecyclerView in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=FEqF1_jDV-A" },
    ...
    "n_app_1": {
        ...
        resources: [
            ...
            { title: "Activity Lifecycle Explained (Coding in Flow)", type: "video_en", url: "https://youtube.com/watch?v=UJN3AL4tiqw" },
            { title: "Activity Lifecycle in Hindi (Smart Programming)", type: "video_hi", url: "https://youtube.com/watch?v=2DYv7aiTTOA" },
    ...
    "n_app_2": {
        ...
        resources: [
            ...
            { title: "Android Fragments Full Tutorial (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=-vAI7RSPxOA" },
            { title: "Fragments in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=7jcXW0Xwd4Y" },
    ...
    "n_app_3": {
        ...
        resources: [
            ...
            { title: "Implicit vs Explicit Intents (CodingWithMitch)", type: "video_en", url: "https://youtube.com/watch?v=4AG-h-zoY4g" },
            { title: "Intents in Hindi (Anuj Bhaiya)", type: "video_hi", url: "https://youtube.com/watch?v=GAGsnRg8rc0" },
    ...
    "n_data_1": {
        ...
        resources: [
            ...
            { title: "Room DB Full Tutorial (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=bOd3wO0uFr8" },
            { title: "Room Database in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=cZRBPGyLw9E" },
    ...
    "n_data_2": {
        ...
        resources: [
            ...
            { title: "Jetpack DataStore Tutorial (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=McnVx7l5awk" },
            { title: "DataStore in Hindi (Smart Programming)", type: "video_hi", url: "https://youtube.com/watch?v=iSueUnYWLyg" },
    ...
    "n_data_3": {
        ...
        resources: [
            ...
            { title: "Scoped Storage Explained (Android Developers)", type: "video_en", url: "https://youtube.com/watch?v=jcO6p5TlcGs" },
            { title: "Android File Storage in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=71hLrfHpCaM" },
    ...
    "n_net_1": {
        ...
        resources: [
            ...
            { title: "Retrofit with Coroutines (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=S-10lLA0nbk" },
            { title: "Retrofit in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=135FpDGJeEQ" },
    ...
    "n_net_2": {
        ...
        resources: [
            ...
            { title: "Moshi vs Gson - Which to Use?", type: "video_en", url: "https://youtube.com/watch?v=dJlIivIqN0o" },
            { title: "JSON Parsing in Android Hindi", type: "video_hi", url: "https://youtube.com/watch?v=fB3oQFW--qg" },
    ...
    "n_net_3": {
        ...
        resources: [
            ...
            { title: "Monitoring Network State (Android Developers)", type: "video_en", url: "https://youtube.com/watch?v=D1ljkrgMot4" },
            { title: "Network Handling in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=pfhqBcNJPOk" },
    ...
    "n_arch_1": {
        ...
        resources: [
            ...
            { title: "MVVM Architecture Tutorial (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=-xTqfilaYow" },
            { title: "MVVM Pattern in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=97BRLkicQd0" },
    ...
    "n_arch_2": {
        ...
        resources: [
            ...
            { title: "Clean Architecture for Android (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=EF33KmyprEQ" },
            { title: "Clean Architecture in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=KMMUR8DIYmo" },
    ...
    "n_arch_3": {
        ...
        resources: [
            ...
            { title: "Hilt Dependency Injection (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=bbMsuI2p1DQ" },
            { title: "Dagger Hilt in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=Qb96NlkQ5-Q" },
    ...
    "n_bg_1": {
        ...
        resources: [
            ...
            { title: "WorkManager Full Tutorial (Coding in Flow)", type: "video_en", url: "https://youtube.com/watch?v=p79pfjDpkyQ" },
            { title: "WorkManager in Hindi (Smart Programming)", type: "video_hi", url: "https://youtube.com/watch?v=p79pfjDpkyQ" },
    ...
    "n_bg_2": {
        ...
        resources: [
            ...
            { title: "Foreground Service Tutorial (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=YZL-_XJSClc" },
            { title: "Android Services in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=4dPHr-2jy1g" },
    ...
    "n_bg_3": {
        ...
        resources: [
            ...
            { title: "BroadcastReceiver Tutorial (CodingWithMitch)", type: "video_en", url: "https://youtube.com/watch?v=eExZ56cqPFw" },
            { title: "Broadcast Receiver in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=A0ridqf13lc" },
    ...
    "n_pub_1": {
        ...
        resources: [
            ...
            { title: "How to Sign & Generate a Release APK (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=bgpyuuzMlo0" },
            { title: "App Signing in Hindi (Smart Programming)", type: "video_hi", url: "https://youtube.com/watch?v=92sKMUmv_wo" },
    ...
    "n_pub_2": {
        ...
        resources: [
            ...
            { title: "How to Publish an App on Google Play (Phillip Lackner)", type: "video_en", url: "https://youtube.com/watch?v=bzhmgkuR0dU" },
            { title: "Play Store Publish in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=Ormjb-BX1sw" },
    ...
    "n_pub_3": {
        ...
        resources: [
            ...
            { title: "CI/CD for Android with GitHub Actions (Aryan Mittal)", type: "video_en", url: "https://youtube.com/watch?v=ciqWMIf7Pz0" },
            { title: "Android CI/CD in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=gLptmcuCx6Q" },
