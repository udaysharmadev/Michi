...
export const topicsData: Record<string, TopicData> = {
    ...
    "n_bas_1": {
        ...
        resources: [
            ...
            { title: "Android Architecture Explained (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Android%20Architecture%20Explained%20(Phillip%20Lackner)" },
    ...
    "n_bas_2": {
        ...
        resources: [
            ...
            { title: "ART vs Dalvik by Mark Allison", type: "video_en", url: "https://www.youtube.com/results?search_query=ART%20vs%20Dalvik%20by%20Mark%20Allison" },
            { title: "ART Runtime in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=ART%20Runtime%20in%20Hindi" },
    ...
    "n_bas_3": {
        ...
        resources: [
            ...
            { title: "Android Runtime Permissions (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Android%20Runtime%20Permissions%20(Phillip%20Lackner)" },
            { title: "Android Permissions in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Android%20Permissions%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_kot_1": {
        ...
        resources: [
            ...
            { title: "Kotlin Crash Course (Traversy Media)", type: "video_en", url: "https://www.youtube.com/results?search_query=Kotlin%20Crash%20Course%20(Traversy%20Media)" },
            { title: "Kotlin Full Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Kotlin%20Full%20Course%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_kot_2": {
        ...
        resources: [
            ...
            { title: "Kotlin Null Safety Explained (Android Developers)", type: "video_en", url: "https://www.youtube.com/results?search_query=Kotlin%20Null%20Safety%20Explained%20(Android%20Developers)" },
            { title: "Null Safety in Kotlin Hindi (Anuj Bhaiya)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Null%20Safety%20in%20Kotlin%20Hindi%20(Anuj%20Bhaiya)" },
    ...
    "n_kot_3": {
        ...
        resources: [
            ...
            { title: "OOP in Kotlin (Coding in Flow)", type: "video_en", url: "https://www.youtube.com/results?search_query=OOP%20in%20Kotlin%20(Coding%20in%20Flow)" },
            { title: "Kotlin OOP in Hindi (Smart Programming)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Kotlin%20OOP%20in%20Hindi%20(Smart%20Programming)" },
    ...
    "n_kot_4": {
        ...
        resources: [
            ...
            { title: "Kotlin Coroutines (Phillip Lackner - full)", type: "video_en", url: "https://www.youtube.com/results?search_query=Kotlin%20Coroutines%20(Phillip%20Lackner%20-%20full)" },
            { title: "Coroutines in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Coroutines%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_tool_1": {
        ...
        resources: [
            ...
            { title: "Android Studio Tutorial (Programming with Mosh)", type: "video_en", url: "https://www.youtube.com/results?search_query=Android%20Studio%20Tutorial%20(Programming%20with%20Mosh)" },
            { title: "Android Studio Setup in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Android%20Studio%20Setup%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_tool_2": {
        ...
        resources: [
            ...
            { title: "Gradle for Android (Coding in Flow)", type: "video_en", url: "https://www.youtube.com/results?search_query=Gradle%20for%20Android%20(Coding%20in%20Flow)" },
            { title: "Gradle Build in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Gradle%20Build%20in%20Hindi" },
    ...
    "n_tool_3": {
        ...
        resources: [
            ...
            { title: "ADB Commands Every Developer Should Know", type: "video_en", url: "https://www.youtube.com/results?search_query=ADB%20Commands%20Every%20Developer%20Should%20Know" },
            { title: "ADB and Fastboot in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=ADB%20and%20Fastboot%20in%20Hindi" },
    ...
    "n_ui_1": {
        ...
        resources: [
            ...
            { title: "ConstraintLayout Tutorial (Coding in Flow)", type: "video_en", url: "https://www.youtube.com/results?search_query=ConstraintLayout%20Tutorial%20(Coding%20in%20Flow)" },
            { title: "Android XML UI in Hindi (Hacking with Android)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Android%20XML%20UI%20in%20Hindi%20(Hacking%20with%20Android)" },
    ...
    "n_ui_2": {
        ...
        resources: [
            ...
            { title: "Jetpack Compose Crash Course (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/watch?v=cDgwZvsJ00w" },
            { title: "Jetpack Compose in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Jetpack%20Compose%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_ui_3": {
        ...
        resources: [
            ...
            { title: "Material Design 3 in Compose (Android)", type: "video_en", url: "https://www.youtube.com/watch?v=cDgwZvsJ00w" },
            { title: "Material 3 Components in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Material%203%20Components%20in%20Hindi" },
    ...
    "n_ui_4": {
        ...
        resources: [
            ...
            { title: "LazyColumn & LazyRow Tutorial (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/watch?v=cDgwZvsJ00w" },
            { title: "RecyclerView in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=RecyclerView%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_app_1": {
        ...
        resources: [
            ...
            { title: "Activity Lifecycle in Hindi (Smart Programming)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Activity%20Lifecycle%20in%20Hindi%20(Smart%20Programming)" },
    ...
    "n_app_2": {
        ...
        resources: [
            ...
            { title: "Android Fragments Full Tutorial (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Android%20Fragments%20Full%20Tutorial%20(Phillip%20Lackner)" },
            { title: "Fragments in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Fragments%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_app_3": {
        ...
        resources: [
            ...
            { title: "Implicit vs Explicit Intents (CodingWithMitch)", type: "video_en", url: "https://www.youtube.com/results?search_query=Implicit%20vs%20Explicit%20Intents%20(CodingWithMitch)" },
            { title: "Intents in Hindi (Anuj Bhaiya)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Intents%20in%20Hindi%20(Anuj%20Bhaiya)" },
    ...
    "n_data_1": {
        ...
        resources: [
            ...
            { title: "Room DB Full Tutorial (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Room%20DB%20Full%20Tutorial%20(Phillip%20Lackner)" },
            { title: "Room Database in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Room%20Database%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_data_2": {
        ...
        resources: [
            ...
            { title: "Jetpack DataStore Tutorial (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Jetpack%20DataStore%20Tutorial%20(Phillip%20Lackner)" },
            { title: "DataStore in Hindi (Smart Programming)", type: "video_hi", url: "https://www.youtube.com/results?search_query=DataStore%20in%20Hindi%20(Smart%20Programming)" },
    ...
    "n_data_3": {
        ...
        resources: [
            ...
            { title: "Scoped Storage Explained (Android Developers)", type: "video_en", url: "https://www.youtube.com/results?search_query=Scoped%20Storage%20Explained%20(Android%20Developers)" },
            { title: "Android File Storage in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Android%20File%20Storage%20in%20Hindi" },
    ...
    "n_net_1": {
        ...
        resources: [
            ...
            { title: "Retrofit with Coroutines (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Retrofit%20with%20Coroutines%20(Phillip%20Lackner)" },
            { title: "Retrofit in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Retrofit%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_net_2": {
        ...
        resources: [
            ...
            { title: "Moshi vs Gson - Which to Use?", type: "video_en", url: "https://www.youtube.com/results?search_query=Moshi%20vs%20Gson%20-%20Which%20to%20Use%3F" },
            { title: "JSON Parsing in Android Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=JSON%20Parsing%20in%20Android%20Hindi" },
    ...
    "n_net_3": {
        ...
        resources: [
            ...
            { title: "Monitoring Network State (Android Developers)", type: "video_en", url: "https://www.youtube.com/results?search_query=Monitoring%20Network%20State%20(Android%20Developers)" },
            { title: "Network Handling in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Network%20Handling%20in%20Hindi" },
    ...
    "n_arch_1": {
        ...
        resources: [
            ...
            { title: "MVVM Architecture Tutorial (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=MVVM%20Architecture%20Tutorial%20(Phillip%20Lackner)" },
            { title: "MVVM Pattern in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=MVVM%20Pattern%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_arch_2": {
        ...
        resources: [
            ...
            { title: "Clean Architecture for Android (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Clean%20Architecture%20for%20Android%20(Phillip%20Lackner)" },
            { title: "Clean Architecture in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Clean%20Architecture%20in%20Hindi" },
    ...
    "n_arch_3": {
        ...
        resources: [
            ...
            { title: "Hilt Dependency Injection (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Hilt%20Dependency%20Injection%20(Phillip%20Lackner)" },
            { title: "Dagger Hilt in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Dagger%20Hilt%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_bg_1": {
        ...
        resources: [
            ...
            { title: "WorkManager Full Tutorial (Coding in Flow)", type: "video_en", url: "https://www.youtube.com/results?search_query=WorkManager%20Full%20Tutorial%20(Coding%20in%20Flow)" },
            { title: "WorkManager in Hindi (Smart Programming)", type: "video_hi", url: "https://www.youtube.com/results?search_query=WorkManager%20in%20Hindi%20(Smart%20Programming)" },
    ...
    "n_bg_2": {
        ...
        resources: [
            ...
            { title: "Foreground Service Tutorial (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=Foreground%20Service%20Tutorial%20(Phillip%20Lackner)" },
            { title: "Android Services in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Android%20Services%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_bg_3": {
        ...
        resources: [
            ...
            { title: "BroadcastReceiver Tutorial (CodingWithMitch)", type: "video_en", url: "https://www.youtube.com/results?search_query=BroadcastReceiver%20Tutorial%20(CodingWithMitch)" },
            { title: "Broadcast Receiver in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Broadcast%20Receiver%20in%20Hindi" },
    ...
    "n_pub_1": {
        ...
        resources: [
            ...
            { title: "How to Sign & Generate a Release APK (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=How%20to%20Sign%20%26%20Generate%20a%20Release%20APK%20(Phillip%20Lackner)" },
            { title: "App Signing in Hindi (Smart Programming)", type: "video_hi", url: "https://www.youtube.com/results?search_query=App%20Signing%20in%20Hindi%20(Smart%20Programming)" },
    ...
    "n_pub_2": {
        ...
        resources: [
            ...
            { title: "How to Publish an App on Google Play (Phillip Lackner)", type: "video_en", url: "https://www.youtube.com/results?search_query=How%20to%20Publish%20an%20App%20on%20Google%20Play%20(Phillip%20Lackner)" },
            { title: "Play Store Publish in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Play%20Store%20Publish%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_pub_3": {
        ...
        resources: [
            ...
            { title: "CI/CD for Android with GitHub Actions (Aryan Mittal)", type: "video_en", url: "https://www.youtube.com/results?search_query=CI%2FCD%20for%20Android%20with%20GitHub%20Actions%20(Aryan%20Mittal)" },
            { title: "Android CI/CD in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Android%20CI%2FCD%20in%20Hindi" },
