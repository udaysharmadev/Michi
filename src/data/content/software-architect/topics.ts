...
export const topics: Record<string, Partial<TopicData>> = {
  "solid_principles": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "SOLID Principles Hindi (CodeWithHarry)", url: "https://www.youtube.com/watch?v=V19VGmFszIk" },
  ...
  "dry_kiss_yagni": {
    ...
    resources: [
      ...
      { type: "video_en", title: "DRY, KISS, YAGNI Explained (Fireship)", url: "https://www.youtube.com/watch?v=9O9waEL-BIo" },
      { type: "video_hi", title: "Programming Principles Hindi", url: "https://www.youtube.com/watch?v=V19VGmFszIk" },
  ...
  "monolith_vs_microservices": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Monolith vs Microservices (TechWorld with Nana)", url: "https://www.youtube.com/watch?v=rv4LlmLmVWk" },
      { type: "video_hi", title: "Microservices Explained Hindi", url: "https://www.youtube.com/watch?v=7IFJb-uLEaI" },
  ...
  "event_driven": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Event Driven Microservices Hindi", url: "https://www.youtube.com/watch?v=JHGkaShoyNs" },
  ...
  "serverless": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Serverless Architecture (IBM Technology)", url: "https://www.youtube.com/watch?v=vxJobGtqKVM" },
      { type: "video_hi", title: "Serverless Computing Hindi", url: "https://www.youtube.com/watch?v=AgOmeANl3ls" },
  ...
  "event_sourcing_cqrs": {
    ...
    resources: [
      ...
      { type: "video_en", title: "CQRS and Event Sourcing Explained (Hussein Nasser)", url: "https://www.youtube.com/watch?v=1jsXzZaCYXA" },
      { type: "video_hi", title: "Event Sourcing Hindi", url: "https://www.youtube.com/watch?v=JHGkaShoyNs" },
  ...
  "cap_theorem": {
    ...
    resources: [
      ...
      { type: "video_en", title: "CAP Theorem in 3 Minutes (Fireship)", url: "https://www.youtube.com/watch?v=k-Yaq8AHlFA" },
  ...
  "sql_vs_nosql": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "SQL vs NoSQL in Hindi", url: "https://www.youtube.com/watch?v=V19VGmFszIk" },
  ...
  "sharding_replication": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Database Sharding Explained (Exponent)", url: "https://www.youtube.com/watch?v=be6PLMKKSto" },
  ...
  "load_balancing": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Load Balancer Hindi (WsCube Tech)", url: "https://www.youtube.com/watch?v=qIcEpCX5zOA" },
  ...
  "rate_limiting": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Rate Limiting System Design (System Design Interview)", url: "https://www.youtube.com/watch?v=FU4WlwfS3G0" },
      { type: "video_hi", title: "Rate Limiting Hindi", url: "https://www.youtube.com/watch?v=FU4WlwfS3G0" },
  ...
  "caching_strategies": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Caching System Design Hindi", url: "https://www.youtube.com/watch?v=xBTGln828Ps" },
  ...
  "message_queues": {
    ...
    resources: [
      ...
      { type: "video_en", title: "RabbitMQ in 100 Seconds (Fireship)", url: "https://www.youtube.com/watch?v=NQ3fZtyXji0" },
      { type: "video_hi", title: "RabbitMQ vs Kafka Hindi", url: "https://www.youtube.com/watch?v=irLb27k5a7Y" },
  ...
  "identity_access": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "JWT Authentication Hindi", url: "https://www.youtube.com/watch?v=-6v9mUOEecw" },
  ...
  "disaster_recovery": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Disaster Recovery in the Cloud", url: "https://www.youtube.com/watch?v=OmASCUJEVy8" },
      { type: "video_hi", title: "Disaster Recovery Hindi", url: "https://www.youtube.com/watch?v=OmASCUJEVy8" },
