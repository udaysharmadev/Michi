...
export const topicsData: Record<string, TopicData> = {
    ...
    "n_eco_1": {
        ...
        resources: [
            ...
            { title: "How to Set Up Apple Developer Account (Sean Allen)", type: "video_en", url: "https://www.youtube.com/results?search_query=How%20to%20Set%20Up%20Apple%20Developer%20Account%20(Sean%20Allen)" },
            { title: "Apple Developer Account Setup in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Apple%20Developer%20Account%20Setup%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_eco_2": {
        ...
        resources: [
            ...
            { title: "iOS Design Principles Explained (Sean Allen)", type: "video_en", url: "https://www.youtube.com/results?search_query=iOS%20Design%20Principles%20Explained%20(Sean%20Allen)" },
            { title: "HIG for iOS in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=HIG%20for%20iOS%20in%20Hindi" },
    ...
    "n_eco_3": {
        ...
        resources: [
            ...
            { title: "iOS Privacy Permissions Explained (Paul Hudson)", type: "video_en", url: "https://www.youtube.com/results?search_query=iOS%20Privacy%20Permissions%20Explained%20(Paul%20Hudson)" },
            { title: "App Privacy in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=App%20Privacy%20in%20Hindi" },
    ...
    "n_swift_1": {
        ...
        resources: [
            ...
            { title: "Swift in 100 Seconds (Fireship)", type: "video_en", url: "https://www.youtube.com/results?search_query=Swift%20in%20100%20Seconds%20(Fireship)" },
            { title: "Swift Programming Full Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Swift%20Programming%20Full%20Course%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_swift_2": {
        ...
        resources: [
            ...
            { title: "Swift Optionals for Beginners (Sean Allen)", type: "video_en", url: "https://www.youtube.com/results?search_query=Swift%20Optionals%20for%20Beginners%20(Sean%20Allen)" },
            { title: "Optionals in Swift Hindi (Code with Chris)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Optionals%20in%20Swift%20Hindi%20(Code%20with%20Chris)" },
    ...
    "n_swift_3": {
        ...
        resources: [
            ...
            { title: "Swift OOP in Hindi (Smart Programming)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Swift%20OOP%20in%20Hindi%20(Smart%20Programming)" },
    ...
    "n_swift_4": {
        ...
        resources: [
            ...
            { title: "Swift Concurrency - async/await (Paul Hudson)", type: "video_en", url: "https://www.youtube.com/results?search_query=Swift%20Concurrency%20-%20async%2Fawait%20(Paul%20Hudson)" },
            { title: "Swift Concurrency in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Swift%20Concurrency%20in%20Hindi" },
    ...
    "n_xcode_1": {
        ...
        resources: [
            ...
            { title: "Xcode Setup and First App in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Xcode%20Setup%20and%20First%20App%20in%20Hindi" },
    ...
    "n_xcode_2": {
        ...
        resources: [
            ...
            { title: "Xcode Debugging in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Xcode%20Debugging%20in%20Hindi" },
    ...
    "n_xcode_3": {
        ...
        resources: [
            ...
            { title: "SPM in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=SPM%20in%20Hindi" },
    ...
    "n_ui_1": {
        ...
        resources: [
            ...
            { title: "UIKit Tutorial in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=UIKit%20Tutorial%20in%20Hindi" },
    ...
    "n_ui_2": {
        ...
        resources: [
            ...
            { title: "Auto Layout Tutorial (Kodeco)", type: "video_en", url: "https://www.youtube.com/results?search_query=Auto%20Layout%20Tutorial%20(Kodeco)" },
            { title: "Auto Layout in Xcode Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Auto%20Layout%20in%20Xcode%20Hindi" },
    ...
    "n_ui_3": {
        ...
        resources: [
            ...
            { title: "SwiftUI Full Tutorial (Paul Hudson - 100 Days of SwiftUI)", type: "video_en", url: "https://www.youtube.com/results?search_query=SwiftUI%20Full%20Tutorial%20(Paul%20Hudson%20-%20100%20Days%20of%20SwiftUI)" },
            { title: "SwiftUI Crash Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=SwiftUI%20Crash%20Course%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_ui_4": {
        ...
        resources: [
            ...
            { title: "iOS Animations Tutorial (Kodeco)", type: "video_en", url: "https://www.youtube.com/results?search_query=iOS%20Animations%20Tutorial%20(Kodeco)" },
            { title: "iOS Animations in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=iOS%20Animations%20in%20Hindi" },
    ...
    "n_arch_1": {
        ...
        resources: [
            ...
            { title: "MVC in iOS Explained (Sean Allen)", type: "video_en", url: "https://www.youtube.com/results?search_query=MVC%20in%20iOS%20Explained%20(Sean%20Allen)" },
            { title: "MVC Architecture in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=MVC%20Architecture%20in%20Hindi" },
    ...
    "n_arch_2": {
        ...
        resources: [
            ...
            { title: "MVVM in iOS with SwiftUI (Phillip Lackner style)", type: "video_en", url: "https://www.youtube.com/results?search_query=MVVM%20in%20iOS%20with%20SwiftUI%20(Phillip%20Lackner%20style)" },
            { title: "MVVM in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=MVVM%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_arch_3": {
        ...
        resources: [
            ...
            { title: "Combine Framework in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Combine%20Framework%20in%20Hindi" },
    ...
    "n_data_1": {
        ...
        resources: [
            ...
            { title: "Core Data in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=Core%20Data%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_data_2": {
        ...
        resources: [
            ...
            { title: "SwiftData Tutorial in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=SwiftData%20Tutorial%20in%20Hindi" },
    ...
    "n_data_3": {
        ...
        resources: [
            ...
            { title: "UserDefaults in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=UserDefaults%20in%20Hindi" },
    ...
    "n_data_4": {
        ...
        resources: [
            ...
            { title: "File System in iOS (Kodeco Tutorial)", type: "video_en", url: "https://www.youtube.com/results?search_query=File%20System%20in%20iOS%20(Kodeco%20Tutorial)" },
            { title: "FileManager in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=FileManager%20in%20Hindi" },
    ...
    "n_net_1": {
        ...
        resources: [
            ...
            { title: "URLSession API Calls in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=URLSession%20API%20Calls%20in%20Hindi" },
    ...
    "n_net_2": {
        ...
        resources: [
            ...
            { title: "Codable Protocol in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Codable%20Protocol%20in%20Hindi" },
    ...
    "n_net_3": {
        ...
        resources: [
            ...
            { title: "WebSockets iOS in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=WebSockets%20iOS%20in%20Hindi" },
    ...
    "n_sync_1": {
        ...
        resources: [
            ...
            { title: "Grand Central Dispatch Tutorial (Kodeco)", type: "video_en", url: "https://www.youtube.com/results?search_query=Grand%20Central%20Dispatch%20Tutorial%20(Kodeco)" },
            { title: "GCD in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=GCD%20in%20Hindi" },
    ...
    "n_sync_2": {
        ...
        resources: [
            ...
            { title: "Operations & OperationQueue in Swift (Kodeco)", type: "video_en", url: "https://www.youtube.com/results?search_query=Operations%20%26%20OperationQueue%20in%20Swift%20(Kodeco)" },
            { title: "OperationQueue in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=OperationQueue%20in%20Hindi" },
    ...
    "n_sync_3": {
        ...
        resources: [
            ...
            { title: "Swift Actors Explained (Vincent Pradeilles)", type: "video_en", url: "https://www.youtube.com/results?search_query=Swift%20Actors%20Explained%20(Vincent%20Pradeilles)" },
            { title: "Swift Actors in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Swift%20Actors%20in%20Hindi" },
    ...
    "n_dev_1": {
        ...
        resources: [
            ...
            { title: "Core Location & MapKit Tutorial (Kodeco)", type: "video_en", url: "https://www.youtube.com/results?search_query=Core%20Location%20%26%20MapKit%20Tutorial%20(Kodeco)" },
            { title: "Maps & Location in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Maps%20%26%20Location%20in%20Hindi" },
    ...
    "n_dev_2": {
        ...
        resources: [
            ...
            { title: "Building a Custom Camera (Kodeco)", type: "video_en", url: "https://www.youtube.com/results?search_query=Building%20a%20Custom%20Camera%20(Kodeco)" },
            { title: "Camera & AVFoundation in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Camera%20%26%20AVFoundation%20in%20Hindi" },
    ...
    "n_dev_3": {
        ...
        resources: [
            ...
            { title: "Push Notifications in iOS (Sean Allen)", type: "video_en", url: "https://www.youtube.com/results?search_query=Push%20Notifications%20in%20iOS%20(Sean%20Allen)" },
            { title: "APNs Setup in Hindi (WsCube Tech)", type: "video_hi", url: "https://www.youtube.com/results?search_query=APNs%20Setup%20in%20Hindi%20(WsCube%20Tech)" },
    ...
    "n_pub_1": {
        ...
        resources: [
            ...
            { title: "iOS Code Signing Explained (Sean Allen)", type: "video_en", url: "https://www.youtube.com/results?search_query=iOS%20Code%20Signing%20Explained%20(Sean%20Allen)" },
            { title: "Provisioning Profiles in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=Provisioning%20Profiles%20in%20Hindi" },
    ...
    "n_pub_2": {
        ...
        resources: [
            ...
            { title: "How to Upload to TestFlight (Kodeco)", type: "video_en", url: "https://www.youtube.com/results?search_query=How%20to%20Upload%20to%20TestFlight%20(Kodeco)" },
            { title: "TestFlight Upload in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=TestFlight%20Upload%20in%20Hindi" },
    ...
    "n_pub_3": {
        ...
        resources: [
            ...
            { title: "App Store Submission Process (Sean Allen)", type: "video_en", url: "https://www.youtube.com/results?search_query=App%20Store%20Submission%20Process%20(Sean%20Allen)" },
            { title: "App Store Submission in Hindi", type: "video_hi", url: "https://www.youtube.com/results?search_query=App%20Store%20Submission%20in%20Hindi" },
