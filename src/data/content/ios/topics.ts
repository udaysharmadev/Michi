...
export const topicsData: Record<string, TopicData> = {
    ...
    "n_eco_1": {
        ...
        resources: [
            ...
            { title: "How to Set Up Apple Developer Account (Sean Allen)", type: "video_en", url: "https://youtube.com/watch?v=DLvdZtTAJrE" },
            { title: "Apple Developer Account Setup in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=gs0vbJClgRQ" },
    ...
    "n_eco_2": {
        ...
        resources: [
            ...
            { title: "iOS Design Principles Explained (Sean Allen)", type: "video_en", url: "https://youtube.com/watch?v=aF2qt5WfprM" },
            { title: "HIG for iOS in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=wipQ0zKQelY" },
    ...
    "n_eco_3": {
        ...
        resources: [
            ...
            { title: "iOS Privacy Permissions Explained (Paul Hudson)", type: "video_en", url: "https://youtube.com/watch?v=tNxEqyUVGck" },
            { title: "App Privacy in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=O-JzFlEpfsY" },
    ...
    "n_swift_1": {
        ...
        resources: [
            ...
            { title: "Swift in 100 Seconds (Fireship)", type: "video_en", url: "https://youtube.com/watch?v=nAchMctX4YA" },
            { title: "Swift Programming Full Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=92h2XcvZ-vM" },
    ...
    "n_swift_2": {
        ...
        resources: [
            ...
            { title: "Swift Optionals for Beginners (Sean Allen)", type: "video_en", url: "https://youtube.com/watch?v=ZL8BFK8bVjk" },
            { title: "Optionals in Swift Hindi (Code with Chris)", type: "video_hi", url: "https://youtube.com/watch?v=IG_JCxSPa_k" },
    ...
    "n_swift_3": {
        ...
        resources: [
            ...
            { title: "Swift OOP in Hindi (Smart Programming)", type: "video_hi", url: "https://youtube.com/watch?v=oQNMjXI0wmg" },
    ...
    "n_swift_4": {
        ...
        resources: [
            ...
            { title: "Swift Concurrency - async/await (Paul Hudson)", type: "video_en", url: "https://youtube.com/watch?v=CKllPbroKyM" },
            { title: "Swift Concurrency in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=3M_gjyDaV08" },
    ...
    "n_xcode_1": {
        ...
        resources: [
            ...
            { title: "Xcode Setup and First App in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=Ckt_Oems_10" },
    ...
    "n_xcode_2": {
        ...
        resources: [
            ...
            { title: "Xcode Debugging in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=ZFdnkxKvJ-U" },
    ...
    "n_xcode_3": {
        ...
        resources: [
            ...
            { title: "SPM in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=WD-Ui3lHQWM" },
    ...
    "n_ui_1": {
        ...
        resources: [
            ...
            { title: "UIKit Tutorial in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=lkU5s5V1GTg" },
    ...
    "n_ui_2": {
        ...
        resources: [
            ...
            { title: "Auto Layout Tutorial (Kodeco)", type: "video_en", url: "https://youtube.com/watch?v=27TFuaOpUsE" },
            { title: "Auto Layout in Xcode Hindi", type: "video_hi", url: "https://youtube.com/watch?v=QdmRt47iyEk" },
    ...
    "n_ui_3": {
        ...
        resources: [
            ...
            { title: "SwiftUI Full Tutorial (Paul Hudson - 100 Days of SwiftUI)", type: "video_en", url: "https://youtube.com/watch?v=b1oC7sLIgpI" },
            { title: "SwiftUI Crash Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=13Zt5xDHYgQ" },
    ...
    "n_ui_4": {
        ...
        resources: [
            ...
            { title: "iOS Animations Tutorial (Kodeco)", type: "video_en", url: "https://youtube.com/watch?v=OYLBUvaiWXY" },
            { title: "iOS Animations in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=Vk7E8VRn76M" },
    ...
    "n_arch_1": {
        ...
        resources: [
            ...
            { title: "MVC in iOS Explained (Sean Allen)", type: "video_en", url: "https://youtube.com/watch?v=JzngncpZLuw" },
            { title: "MVC Architecture in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=pAHVSpbftYY" },
    ...
    "n_arch_2": {
        ...
        resources: [
            ...
            { title: "MVVM in iOS with SwiftUI (Phillip Lackner style)", type: "video_en", url: "https://youtube.com/watch?v=-xTqfilaYow" },
            { title: "MVVM in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=97BRLkicQd0" },
    ...
    "n_arch_3": {
        ...
        resources: [
            ...
            { title: "Combine Framework in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=zo3sTqOpZO0" },
    ...
    "n_data_1": {
        ...
        resources: [
            ...
            { title: "Core Data in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=4vXEjJVrrTU" },
    ...
    "n_data_2": {
        ...
        resources: [
            ...
            { title: "SwiftData Tutorial in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=hJ2XpvQt52E" },
    ...
    "n_data_3": {
        ...
        resources: [
            ...
            { title: "UserDefaults in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=b94csoxdGuU" },
    ...
    "n_data_4": {
        ...
        resources: [
            ...
            { title: "File System in iOS (Kodeco Tutorial)", type: "video_en", url: "https://youtube.com/watch?v=eC7_cddT6wM" },
            { title: "FileManager in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=mUrhYBHHJaY" },
    ...
    "n_net_1": {
        ...
        resources: [
            ...
            { title: "URLSession API Calls in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=3M_gjyDaV08" },
    ...
    "n_net_2": {
        ...
        resources: [
            ...
            { title: "Codable Protocol in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=LDTooIQtOrA" },
    ...
    "n_net_3": {
        ...
        resources: [
            ...
            { title: "WebSockets iOS in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=favi7avxIag" },
    ...
    "n_sync_1": {
        ...
        resources: [
            ...
            { title: "Grand Central Dispatch Tutorial (Kodeco)", type: "video_en", url: "https://youtube.com/watch?v=ikGIZq1s9-A" },
            { title: "GCD in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=w11LLJXGFhE" },
    ...
    "n_sync_2": {
        ...
        resources: [
            ...
            { title: "Operations & OperationQueue in Swift (Kodeco)", type: "video_en", url: "https://youtube.com/watch?v=JuFAW7y8lp0" },
            { title: "OperationQueue in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=JuFAW7y8lp0" },
    ...
    "n_sync_3": {
        ...
        resources: [
            ...
            { title: "Swift Actors Explained (Vincent Pradeilles)", type: "video_en", url: "https://youtube.com/watch?v=xlSfWPb2hz0" },
            { title: "Swift Actors in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=USz17wtIKG8" },
    ...
    "n_dev_1": {
        ...
        resources: [
            ...
            { title: "Core Location & MapKit Tutorial (Kodeco)", type: "video_en", url: "https://youtube.com/watch?v=FsLq3eoz6OQ" },
            { title: "Maps & Location in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=QULMYsdWXpU" },
    ...
    "n_dev_2": {
        ...
        resources: [
            ...
            { title: "Building a Custom Camera (Kodeco)", type: "video_en", url: "https://youtube.com/watch?v=ik1QRc_kN9M" },
            { title: "Camera & AVFoundation in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=ik1QRc_kN9M" },
    ...
    "n_dev_3": {
        ...
        resources: [
            ...
            { title: "Push Notifications in iOS (Sean Allen)", type: "video_en", url: "https://youtube.com/watch?v=srqiDnLEocA" },
            { title: "APNs Setup in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=Jhi2jinS9rQ" },
    ...
    "n_pub_1": {
        ...
        resources: [
            ...
            { title: "iOS Code Signing Explained (Sean Allen)", type: "video_en", url: "https://youtube.com/watch?v=XTAziR-tY-A" },
            { title: "Provisioning Profiles in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=MjHOvBMx8cQ" },
    ...
    "n_pub_2": {
        ...
        resources: [
            ...
            { title: "How to Upload to TestFlight (Kodeco)", type: "video_en", url: "https://youtube.com/watch?v=6VuLukGpNv8" },
            { title: "TestFlight Upload in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=TMJUNxoTxxo" },
    ...
    "n_pub_3": {
        ...
        resources: [
            ...
            { title: "App Store Submission Process (Sean Allen)", type: "video_en", url: "https://youtube.com/watch?v=DLvdZtTAJrE" },
            { title: "App Store Submission in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=_P-bJW-4TmY" },
