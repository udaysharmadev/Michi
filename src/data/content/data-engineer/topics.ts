...
export const topics: Record<string, Partial<TopicData>> = {
  "sql_advanced": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Advanced SQL Course (freeCodeCamp)", url: "https://www.youtube.com/watch?v=wgGkAcFz2G8" },
      { type: "video_hi", title: "Advanced SQL Hindi (CodeWithHarry)", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "nosql_dbs": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "NoSQL Databases Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "db_modeling": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Data Modeling Masterclass", url: "https://www.youtube.com/watch?v=hS5xSAyPzHs" },
      { type: "video_hi", title: "Star Schema and Data Modeling Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "snowflake": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Snowflake Architecture Explained", url: "https://www.youtube.com/watch?v=x0E-2F_4_p8" },
      { type: "video_hi", title: "Snowflake Data Warehouse Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "bigquery": {
    ...
    resources: [
      ...
      { type: "video_en", title: "BigQuery Architecture (Google Cloud)", url: "https://www.youtube.com/watch?v=hS5xSAyPzHs" },
      { type: "video_hi", title: "BigQuery Tutorial Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "redshift": {
    ...
    resources: [
      ...
      { type: "video_en", title: "AWS Redshift Masterclass", url: "https://www.youtube.com/watch?v=VriqpZSHBd8" },
      { type: "video_hi", title: "Amazon Redshift Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "hadoop": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Hadoop Ecosystem Explained", url: "https://www.youtube.com/watch?v=hS5xSAyPzHs" },
      { type: "video_hi", title: "Hadoop Architecture Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "spark": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Spark Tutorial (freeCodeCamp)", url: "https://www.youtube.com/watch?v=FqMTEGqO2c0" },
      { type: "video_hi", title: "Apache Spark in Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "mapreduce": {
    ...
    resources: [
      ...
      { type: "video_en", title: "MapReduce Explained (Computerphile)", url: "https://www.youtube.com/watch?v=cvh-qlVHnxc" },
      { type: "video_hi", title: "MapReduce Architecture Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "kafka": {
    ...
    resources: [
      ...
      { type: "video_hi", title: "Kafka Tutorial Hindi (CodeWithHarry)", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "flink": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Stream Processing with Flink", url: "https://www.youtube.com/watch?v=hS5xSAyPzHs" },
      { type: "video_hi", title: "Apache Flink Architecture Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "spark_streaming": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Spark Streaming Tutorial", url: "https://www.youtube.com/watch?v=qWru-b6m030" },
      { type: "video_hi", title: "Spark Streaming Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "airflow": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Airflow Tutorial for Beginners", url: "https://www.youtube.com/watch?v=K9AnJ9peLbc" },
      { type: "video_hi", title: "Apache Airflow Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "dagster": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Introduction to Dagster", url: "https://www.youtube.com/watch?v=hS5xSAyPzHs" },
      { type: "video_hi", title: "Dagster vs Airflow Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
  ...
  "prefect": {
    ...
    resources: [
      ...
      { type: "video_en", title: "Prefect 2.0 Crash Course", url: "https://www.youtube.com/watch?v=hS5xSAyPzHs" },
      { type: "video_hi", title: "Prefect vs Airflow Hindi", url: "https://www.youtube.com/watch?v=dlO-pGLCJPk" },
