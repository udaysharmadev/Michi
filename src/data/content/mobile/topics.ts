...
export const topicsData: Record<string, TopicData> = {
    ...
    "n_me_1": {
        ...
        resources: [
            ...
            { title: "Flutter vs React Native in 2024 (Fireship)", type: "video_en", url: "https://youtube.com/watch?v=X8ipUgXH6jw" },
            { title: "React Native vs Flutter in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=ahVROQB_C1A" },
    ...
    "n_me_2": {
        ...
        resources: [
            ...
            { title: "Android vs iOS Architecture Explained", type: "video_en", url: "https://youtube.com/watch?v=epAykGvv0Vk" },
    ...
    "n_me_3": {
        ...
        resources: [
            ...
            { title: "App Lifecycle in Hindi (Smart Programming)", type: "video_hi", url: "https://youtube.com/watch?v=6RhdX-d_pbY" },
    ...
    "n_pf_1": {
        ...
        resources: [
            ...
            { title: "JavaScript for React Native (Net Ninja)", type: "video_en", url: "https://youtube.com/watch?v=gvkqT_Uoahw" },
            { title: "JavaScript Full Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=D_Zj9RKYXsE" },
    ...
    "n_pf_2": {
        ...
        resources: [
            ...
            { title: "Dart Programming Full Course (Traversy Media)", type: "video_en", url: "https://youtube.com/watch?v=JZukfxvc7Mc" },
            { title: "Dart Full Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=NftHOCT04Pk" },
    ...
    "n_pf_3": {
        ...
        resources: [
            ...
            { title: "Kotlin vs Swift - Side by Side Comparison", type: "video_en", url: "https://youtube.com/watch?v=cdmWxmqnzLc" },
            { title: "Kotlin Basics in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=FlBhpm9aRUg" },
    ...
    "n_cp_1": {
        ...
        resources: [
            ...
            { title: "React Native Crash Course (Traversy Media)", type: "video_en", url: "https://youtube.com/watch?v=XCifkDC0yXA" },
            { title: "React Native Full Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=JKccS9k56_I" },
    ...
    "n_cp_2": {
        ...
        resources: [
            ...
            { title: "Flutter Crash Course (Traversy Media)", type: "video_en", url: "https://youtube.com/watch?v=1gDhl4leEzA" },
            { title: "Flutter Full Course in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=1bQwDO88Gyw" },
    ...
    "n_cp_3": {
        ...
        resources: [
            ...
            { title: "Expo Tutorial for Beginners (Simon Grimm)", type: "video_en", url: "https://youtube.com/watch?v=cs-zgHjt5RQ" },
            { title: "Expo React Native in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=WSppuT4A09Y" },
    ...
    "n_ui_1": {
        ...
        resources: [
            ...
            { title: "React Navigation v6 Tutorial (Traversy)", type: "video_en", url: "https://youtube.com/watch?v=nST4aDdYOU4" },
            { title: "React Navigation in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=Jj3lM7KIKkA" },
    ...
    "n_ui_2": {
        ...
        resources: [
            ...
            { title: "GoRouter Tutorial (Reso Coder)", type: "video_en", url: "https://youtube.com/watch?v=b6Z885Z46cU" },
            { title: "Flutter Navigation in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=1YxHlJyjQWM" },
    ...
    "n_ui_3": {
        ...
        resources: [
            ...
            { title: "Styling in React Native (Simon Grimm)", type: "video_en", url: "https://youtube.com/watch?v=zuFh9lfb4HY" },
            { title: "React Native Styling in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=ahVROQB_C1A" },
    ...
    "n_ui_4": {
        ...
        resources: [
            ...
            { title: "Reanimated 3 Tutorial (William Candillon)", type: "video_en", url: "https://youtube.com/watch?v=xPbRsca_l7c" },
            { title: "React Native Animations in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=p6v4oEe5ohk" },
    ...
    "n_sm_1": {
        ...
        resources: [
            ...
            { title: "Redux Toolkit Full Tutorial (Dave Gray)", type: "video_en", url: "https://youtube.com/watch?v=NqzdVN2tyvQ" },
            { title: "Redux Toolkit in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=ZP6zJLGdR8s" },
    ...
    "n_sm_2": {
        ...
        resources: [
            ...
            { title: "Zustand Crash Course (Jack Herrington)", type: "video_en", url: "https://youtube.com/watch?v=_qCRuFrdhYw" },
            { title: "Zustand State Management in Hindi", type: "video_hi", url: "https://youtube.com/watch?v=oRNdGJkrvIA" },
    ...
    "n_sm_3": {
        ...
        resources: [
            ...
            { title: "Riverpod 2.0 Full Tutorial (Reso Coder)", type: "video_en", url: "https://youtube.com/watch?v=Zp7VKVhirmw" },
            { title: "Flutter Bloc in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=EFSFfEtznmU" },
    ...
    "n_api_1": {
        ...
        resources: [
            ...
            { title: "Axios in React Native (Simon Grimm)", type: "video_en", url: "https://youtube.com/watch?v=PjQhUnorJeA" },
            { title: "API Calling in React Native Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=vn3TO3_F8ag" },
    ...
    "n_api_2": {
        ...
        resources: [
            ...
            { title: "Socket.io with React Native Tutorial", type: "video_en", url: "https://youtube.com/watch?v=9vxgxqlC6v0" },
            { title: "WebSockets in React Native Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=favi7avxIag" },
    ...
    "n_api_3": {
        ...
        resources: [
            ...
            { title: "Push Notifications in React Native with Expo", type: "video_en", url: "https://youtube.com/watch?v=p4KP-hXuDyI" },
            { title: "Push Notifications in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=crJaLpCiNfI" },
    ...
    "n_api_4": {
        ...
        resources: [
            ...
            { title: "Auth in React Native (Traversy)", type: "video_en", url: "https://youtube.com/watch?v=bCpFbERgj7s" },
            { title: "React Native Authentication in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=sNLoRilN_RI" },
    ...
    "n_data_1": {
        ...
        resources: [
            ...
            { title: "MMKV in React Native (Phillip Lackner style)", type: "video_en", url: "https://youtube.com/watch?v=7N5fug4O-zg" },
            { title: "AsyncStorage & Storage in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=pY-UvlALKhw" },
    ...
    "n_data_2": {
        ...
        resources: [
            ...
            { title: "WatermelonDB + React Native Tutorial", type: "video_en", url: "https://youtube.com/watch?v=7k1GVj9Y-hI" },
            { title: "SQLite in React Native Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=HQo4Nr2d3DA" },
    ...
    "n_data_3": {
        ...
        resources: [
            ...
            { title: "Firebase with React Native Tutorial", type: "video_en", url: "https://youtube.com/watch?v=a0KJ7l5sNGw" },
            { title: "Firebase Firestore in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=Nmof6xhlDlE" },
    ...
    "n_dep_1": {
        ...
        resources: [
            ...
            { title: "EAS Build Tutorial (Simon Grimm)", type: "video_en", url: "https://youtube.com/watch?v=cs-zgHjt5RQ" },
            { title: "EAS Build & Deploy in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=mPCif7nRHrM" },
    ...
    "n_dep_2": {
        ...
        resources: [
            ...
            { title: "Fastlane for iOS & Android CI/CD", type: "video_en", url: "https://youtube.com/watch?v=yNqCpMLmJqE" },
            { title: "Fastlane CI/CD Setup in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=57dkyTmOCmE" },
    ...
    "n_dep_3": {
        ...
        resources: [
            ...
            { title: "Publishing to App Store & Play Store Guide", type: "video_en", url: "https://youtube.com/watch?v=WOKrelHPefc" },
            { title: "App Store Submission in Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=Ormjb-BX1sw" },
    ...
    "n_dep_4": {
        ...
        resources: [
            ...
            { title: "CodePush OTA Updates Tutorial", type: "video_en", url: "https://youtube.com/watch?v=3ww3FlJcPeo" },
            { title: "OTA Updates in React Native Hindi (WsCube Tech)", type: "video_hi", url: "https://youtube.com/watch?v=XCyw6Emfvdw" },
